...
<body>
	...
	<form method="post">
		...
		<table border="1" align="center">
			...
			<?php
			$sel = "select * from teacher join city on teacher.t_city=city.cty_id where t_id='" . $_SESSION['userid'] . "'";
			// $sel = "select * from teacher join city on teacher.t_city=city.cty_id";
			$qq = $con->query($sel);
			while ($ff = $qq->fetch_object()) {
			?>
				<tr>
					<!-- <td><input type="checkbox" name="hh[]" value="<?php echo $ff->t_id; ?>"></td> -->
					...
					<!-- <td><a href="tech_home.php?del=<?php echo $ff->t_id; ?>">Delete</a></td> -->
		...
		<table border="1" align="center">
			...
			?>
				<tr>
					...
					<td><?php echo $ff->cty_name; ?></td>
					<td><?php echo $ff->Role; ?></td>
					<td><a href="tech_home.php?del=<?php echo $ff->stu_id; ?>">Delete</a></td>
					<td><a href="stu_update.php?stuedt=<?php echo $ff->stu_id; ?>">Edit</a></td>
			...
			?>
			<tr>
				<td align="center" colspan="16"><input type="submit" name="mul" value="Delete"></td>
			</tr>
		</table>
	</form>
</body>
